...
function createFeatures(eqData) {
  ...
  // Create a GeoJSON layer, contain features array, run on the function for each array entry
...
legend.onAdd = function (map) {
    ...
    // loop to create colors for the magnitudes 
